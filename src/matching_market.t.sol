...
contract MarketTester {
    ...
    function doSetDustLimitAmount(address sellGem, uint minAmt) public returns (bool) {
...
contract OrderMatchingGasTest is DSTest {
    ...
    function execOrderMatchingGasTest(uint matchOrderCount) public {
        ...
        assertEq(otc.span(address(dai), address(mkr)), 0);
    }
    ...
    function execOrderInsertGasTest(uint offerIndex, uint kind) public {
        ...
        if (kind == 0) {                // no frontend aid
            ...
            assertEq(otc.span(address(dai), address(mkr)), offerIndex + 2);
            ...
            assertEq(otc.span(address(dai), address(mkr)), offerIndex + 1);
...
contract OrderMatchingTest is DSTest, EventfulMarket, MatchingEvents {
    ...
    function testDustMakerOfferCanceled() public {
        ...
        otc.setDustLimit(address(dai), 10);
    ...
    function testDustNotNewOfferIsCreated() public {
        dai.transfer(address(user1), 30);
        user1.doApprove(address(otc), 30, dai);
        mkr.approve(address(otc), 25);
        otc.setDustLimit(address(dai), 10);
        uint id0 = otc.limitOffer(25, mkr, 25, dai, false, 0);
        uint id1 = user1.doLimitOffer(30, dai, 30, mkr, false, 0);
        assertTrue(!otc.isActive(id0));
        assertTrue(!otc.isActive(id1));
    }
    ...
    function testDustTakerOfferNotCreated() public {
        ...
        otc.setDustLimit(address(mkr), 10);
    ...
    function testFailTooBigOffersToMatch() public {
        ...
        dai.transfer(address(user1), makerSell);
        user1.doApprove(address(otc), makerSell, dai);
        mkr.approve(address(otc), takerSell);
        otc.setDustLimit(address(mkr), takerSell);
    ...
    function testGetFirstNextUnsortedOfferAfterInsertOne() public {
        ...
        assertEq(otc.best(address(mkr), address(dai)), offerId[3]);
    }
    ...
    function testSetGetDustLimitAmout() public {
        otc.setDustLimit(address(dai), 100);
        assertEq(otc.dust(address(dai)), 100);
    }

    function testFailOfferSellsLessThanRequired() public {
        mkr.approve(address(otc), 30);
        otc.setDustLimit(address(mkr), 31);
        assertEq(otc.dust(address(mkr)), 31);
        offerId[1] = otc.limitOffer(30, mkr, 100, dai, false, 0);
    }

    function testFailNonOwnerCanNotSetSellAmount() public {
        user1.doSetDustLimitAmount(address(dai),100);
    }

    function testOfferSellsMoreThanOrEqualThanRequired() public {
        mkr.approve(address(otc), 30);
        otc.setDustLimit(address(mkr),30);
        assertEq(otc.dust(address(mkr)), 30);
    ...
    function testOrderMatchRounding() public {
        ...
        uint oldDAIBal = dai.balanceOf(address(user1));
        uint oldDGDBal = dgd.balanceOf(address(user1));
        ...
        assertEq(dgd.balanceOf(address(user1)) - oldDGDBal, DGDBuy);
        assertEq(oldDAIBal - dai.balanceOf(address(user1)), DAISell + expectedOverpay);
    }
    ...
    function testBestOfferWithOneOffer() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[1]);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 1);
    }
    ...
    function testBestOfferWithTwoOffers() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[2]);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), offerId[1]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 2);
    }
    ...
    function testBestOfferWithThreeOffers() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[3]);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), offerId[1]);
        assertEq(otc.getWorseOffer(offerId[3]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        ...
        assertEq(otc.span(address(dai), address(mkr)), 3);
    }
    ...
    function testBestOfferWithFourOffersDeleteBetween() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[4]);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), offerId[1]);
        assertEq(otc.getWorseOffer(offerId[3]), offerId[2]);
        ...
        assertEq(otc.span(address(dai), address(mkr)), 4);
    ...
    function testBestOfferWithTwoOffersDeletedLowest() public {
        ...
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 1);
        assertTrue(!otc.isActive(offerId[1]));
    }
    ...
    function testBestOfferWithTwoOffersDeletedHighest() public {
        ...
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 1);
        assertTrue(!otc.isActive(offerId[2]));
    }
    ...
    function testBestOfferWithThreeOffersDeletedHighest() public {
        ...
        assertEq(otc.getBetterOffer(offerId[3]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 2);
        assertTrue(!otc.isActive(offerId[3]));
    }
    ...
    function testBestOfferWithTwoOffersWithDifferentTokens() public {
        ...
        assertEq(otc.best(address(dai), address(dgd)), offerId[1]);
        assertEq(otc.best(address(dai), address(mkr)), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), 0);
        assertEq(otc.span(address(dai), address(dgd)), 1);
        assertEq(otc.span(address(dai), address(mkr)), 1);
    }
    ...
    function testBestOfferWithFourOffersWithDifferentTokens() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[2]);
        assertEq(otc.best(address(dai), address(dgd)), offerId[4]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.getBetterOffer(offerId[3]), offerId[4]);
        assertEq(otc.getBetterOffer(offerId[4]), 0);
        ...
        assertEq(otc.getWorseOffer(offerId[4]), offerId[3]);
        assertEq(otc.span(address(dai), address(mkr)), 2);
        assertEq(otc.span(address(dai), address(dgd)), 2);
    }
    ...
    function testBestOfferWithSixOffersWithDifferentTokens() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[3]);
        assertEq(otc.best(address(dai), address(dgd)), offerId[6]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[2]), offerId[3]);
        assertEq(otc.getBetterOffer(offerId[3]), 0);
        ...
        assertEq(otc.span(address(dai), address(mkr)), 3);
        assertEq(otc.span(address(dai), address(dgd)), 3);
    }
    ...
    function testBestOfferWithEightOffersWithDifferentTokens() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[4]);
        assertEq(otc.best(address(dai), address(dgd)), offerId[8]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[2]), offerId[3]);
        assertEq(otc.getBetterOffer(offerId[3]), offerId[4]);
        assertEq(otc.getBetterOffer(offerId[4]), 0);
        ...
        assertEq(otc.span(address(dai), address(mkr)), 4);
        assertEq(otc.span(address(dai), address(dgd)), 4);
    }
    ...
    function testBestOfferWithFourOffersWithDifferentTokensHighLowDeleted() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[1]);
        assertEq(otc.best(address(dai), address(dgd)), offerId[3]);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.getBetterOffer(offerId[3]), 0);
        assertEq(otc.getBetterOffer(offerId[4]), 0);
        ...
        assertEq(otc.span(address(dai), address(dgd)), 1);
        assertTrue(!otc.isActive(offerId[2]));
        assertTrue(!otc.isActive(offerId[4]));
    }
    ...
    function testBestOfferWithSixOffersWithDifferentTokensLowHighDeleted() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[3]);
        assertEq(otc.best(address(dai), address(dgd)), offerId[5]);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getBetterOffer(offerId[2]), offerId[3]);
        assertEq(otc.getBetterOffer(offerId[3]), 0);
        assertEq(otc.getBetterOffer(offerId[4]), offerId[5]);
        ...
        assertEq(otc.span(address(dai), address(dgd)), 2);
        assertTrue(!otc.isActive(offerId[1]));
        assertTrue(!otc.isActive(offerId[6]));
    }
    ...
    function testInsertOfferWithUserProvidedIdOfADifferentToken() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[2]) == 0);
        assertTrue(otc.getWorseOffer(offerId[2]) == 0);
    }
    ...
    function testInsertOfferWithUserProvidedIdOfASameTokenHigherToHighestWrongPos() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[4]) == 0);
        assertTrue(otc.getWorseOffer(offerId[4]) == offerId[2]);
    }
    ...
    function testInsertOfferWithUserProvidedIdOfASameTokenHigherToBetweenWrongPos() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[4]) == 0);
        assertTrue(otc.getWorseOffer(offerId[4]) == offerId[1]);
    }
    ...
    function testInsertOfferWithUserProvidedIdOfASameTokenHigherToHighestWrongPosLowest() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[4]) == offerId[3]);
        assertTrue(otc.getWorseOffer(offerId[4]) == 0);
    }
    ...
    function testInsertOfferWithUserProvidedIdOfASameTokenHigherToLowestWrongPosLowest() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[4]) == offerId[2]);
        assertTrue(otc.getWorseOffer(offerId[4]) == 0);
    }
    ...
    function testInsertOfferWithUserProvidedIdOfASameTokenHigherToBetween() public {
        ...
        assertTrue(otc.getBetterOffer(offerId[4]) == offerId[1]);
        assertTrue(otc.getWorseOffer(offerId[4]) == offerId[3]);
    }
    ...
    function testOfferMatchingOneOnOneMatch() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), 0);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 0);
        assertTrue(!otc.isActive(offerId[1]));
    ...
    function testOfferMatchingOneOnOneMatchCheckOfferPriceRemainsTheSame() public {
        ...
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.span(address(dai), address(mkr)), 0);
        assertEq(otc.span(address(mkr), address(dai)), 1);
        assertTrue(!otc.isActive(offerId[1]));
    ...
    function testOfferMatchingPartialSellTwoOffers() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), 0);
        assertEq(otc.best(address(mkr), address(dai)), offerId[1]);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), 0);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
    ...
    function testOfferMatchingPartialBuyTwoOffers() public {
        ...
        assertEq(otc.best(address(dai), address(mkr)), offerId[2]);
        assertEq(otc.best(address(mkr), address(dai)), 0);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), 0);
        assertEq(otc.getBetterOffer(offerId[1]), 0);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.span(address(mkr), address(dai)), 0);
        assertEq(otc.span(address(dai), address(mkr)), 1);
        assertTrue(!otc.isActive(offerId[1]));
        assertEq(sellAmt, 5);
        assertEq(buyAmt, 5);
    ...
    function testOfferMatchingPartialBuyThreeOffers() public {
        ...
        assertEq(otc.best(address(mkr), address(dai)), offerId[2]);
        assertEq(otc.best(address(dai), address(mkr)), 0);
        assertEq(otc.getWorseOffer(offerId[1]), 0);
        assertEq(otc.getWorseOffer(offerId[2]), offerId[1]);
        assertEq(otc.getBetterOffer(offerId[1]), offerId[2]);
        assertEq(otc.getBetterOffer(offerId[2]), 0);
        assertEq(otc.span(address(mkr), address(dai)), 2);
        assertEq(otc.span(address(dai), address(mkr)), 0);
        assertTrue(!otc.isActive(offerId[3]));
        assertEq(sellAmt, 5);
        assertEq(buyAmt, 10);
        ...
        assertTrue(address(sellGem) > address(0));
        assertTrue(address(buyGem) > address(0));
        assertTrue(address(sellGem1) > address(0));
        assertTrue(address(buyGem1) > address(0));
    }
    ...
    function testBuyOffers() public {
        mkr.approve(address(otc), uint(-1));
        user1.doApprove(address(otc), uint(-1), dai);
        dai.transfer(address(user1), 6000 ether);
        ...
        uint initialBalance = mkr.balanceOf(address(this));
        otc.iocOffer(20 ether, mkr, 6000 ether, dai, false);
        // Just bought one of the offers
        assertEq(mkr.balanceOf(address(this)), initialBalance - 10 ether);
    ...
    function testForceBuyAmount() public {
        ...
        uint initialBalanceMKR = mkr.balanceOf(address(this));
        uint initialBalanceDAI = dai.balanceOf(address(this));
        otc.iocOffer(20 ether, mkr, 5000 ether, dai, false); // Price: 250
        assertEq(dai.balanceOf(address(this)), initialBalanceDAI + 5000 ether);
        uint mkrSold = 10 ether + div(1800 ether * 10, 2800 ether);
        assertEq(mkr.balanceOf(address(this)), initialBalanceMKR - mkrSold);
    }
    ...
    function testForceSellAmount() public {
        ...
        assertEq(mkr.balanceOf(address(this)), initialBalanceMKR - 20 ether);
        assertEq(dai.balanceOf(address(this)), initialBalanceDAI + 6000 ether);
    }
    ...
    function testForceBuyAmountOffer() public {
        ...
        assertEq(dai.balanceOf(address(this)), initialBalanceDAI + 4600 ether);
        ...
        assertEq(mkr.balanceOf(address(this)), initialBalanceMKR - 15 ether - offerSellAmtToBuyMissingDAI);
    }
    ...
    function testForceSellAmountOffer() public {
        ...
        assertEq(mkr.balanceOf(address(this)), initialBalanceMKR - 12 ether);
        assertEq(dai.balanceOf(address(this)), initialBalanceDAI + 3000 ether);
        (,, sellAmt,, buyAmt,,,) = otc.offers(offerId[4]);
    ...
    function testEvilOfferPositions() public {
        ...
        assertTrue(oSellAmt == 1 ether && oBuyAmt == 301 ether);

        uint currentId = otc.best(address(dai), address(mkr));
        (oSellAmt, oBuyAmt,,,,,,) = otc.offers(currentId);
        assertTrue(oSellAmt == 280 ether && oBuyAmt == 1 ether);

        currentId = otc.getWorseOffer(currentId);
        (oSellAmt, oBuyAmt,,,,,,) = otc.offers(currentId);
        assertTrue(oSellAmt == 275 ether && oBuyAmt == 1 ether);

        currentId = otc.getWorseOffer(currentId);
        (oSellAmt, oBuyAmt,,,,,,) = otc.offers(currentId);
        assertTrue(oSellAmt == 250 ether && oBuyAmt == 1 ether);
    }
    ...
    function testLimitOfferOtherOwner() public {
        mkr.approve(address(otc), uint(-1));
        user1.doApprove(address(otc), uint(-1), dai);
        dai.transfer(address(user1), 1600 ether);
        offerId[1] = user1.doLimitOffer(1600 ether, dai, 5 ether, mkr, false, 0); // Price: 320
