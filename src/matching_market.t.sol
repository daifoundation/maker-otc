...
contract OrderMatchingTest is DSTest, EventfulMarket, MatchingEvents {
	...
	assertTrue(otc.getBetterOffer(offer_id[2]) == 0);
	assertTrue(otc.getWorseOffer(offer_id[2]) == 0);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == 0);
	assertTrue(otc.getWorseOffer(offer_id[4]) == 0);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == 0);
	assertTrue(otc.getWorseOffer(offer_id[4]) == offer_id[2]);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == 0);
	assertTrue(otc.getWorseOffer(offer_id[4]) == offer_id[1]);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == offer_id[3]);
	assertTrue(otc.getWorseOffer(offer_id[4]) == 0);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == offer_id[2]);
	assertTrue(otc.getWorseOffer(offer_id[4]) == 0);
    }
	...
	assertTrue(otc.getBetterOffer(offer_id[4]) == offer_id[1]);
	assertTrue(otc.getWorseOffer(offer_id[4]) == offer_id[3]);
    }
    ...
    function testOfferMatchingOneOnOneMatchCheckOfferPriceRemainsTheSame() public {
        ...
        assertTrue(!otc.isActive(offer_id[1]));
        //assertTrue price of offer_id[2] should be the same as before matching
        assertEq(sell_val, 5);
        assertEq(buy_val, 5);
    ...
    function testOfferMatchingOneOnTwoMatchCheckOfferPriceRemainsTheSame() public {
        ...
        assertEq(otc.getOfferCount(mkr, dai), 1);
        assertTrue(!otc.isActive(offer_id[1]));
        //assertTrue érice of offer_id[2] should be the same as before matching
        assertEq(sell_val, 1);
        assertEq(buy_val, 1);
        assertTrue(address(sell_token) != address(0));
        assertTrue(address(buy_token) != address(0));
